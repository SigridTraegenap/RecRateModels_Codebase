...
Run this script from its own folder:
    cd Example_Networks
    conda run -n tf_pyth python run_spont_network_structInputs.py
'''
...
import tools_2D.simulate.brain_network_tf as bn
...
Save_key = 'loop_reload_25-12-12_N60_linear'
...
plt.savefig('test_Input_spont.pdf')
plt.show()
...
plt.savefig('test_spont_pattern.pdf')
plt.show()
