...
from Modular_2D.simulate.tools import generate_input_RF
...
class InputLayer_evoked:
    ...
    def _init_receptivefields(self):
        ...
        for i in np.arange(self.N):
            for j in np.arange(self.M):
                ...
                composite_rf, on_rf,off_rf=generate_input_RF.create_subfieldRF(
    ...
    def _generate_stim(self,
        ...
        stim = generate_input_RF.SinuisoidGrating(
...
if __name__=='__main__':
    ...
    receptive_field_params={
        ...
        'l4_activity_mode'      : 'simple_cell_pure',
        'base_rate'             : 0,
    ...
    #
    stim_angle=0
    stim = generate_input_RF.SinuisoidGrating(size_stimulated_VF, A=1,
                                              angle=stim_angle,
                         frequency_Kspace=1/2,
